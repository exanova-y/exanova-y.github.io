...
Yoyo: Everything below will be a quote or notes by me. Close the world if you don't want to read personal stuff.

My goals are still the same. I need to fund my cog sci research. Preferably rapidly, by running startups while working (write code). Anything really. I'm also trying to get grants directly which is hard without legiblity. Can't wait until the day it becomes true. After the 2023 situation, I doubted myself, executed not enough and also lost on grit.

Why isn't neuralink working on neural dust? 02/23/2025

Truesight by Celeste is really cool. It tries to guess the topics you're most interested in, alternating between exploration and exploitation rounds. oh! You could also create a force directed graph of your friends (making a bunch of obsidian pages is easy)
